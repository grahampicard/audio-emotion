...
if __name__ == "__main__":
    ...
    parser.add_argument('--features', type=bool, default=True, metavar='N', help='Process CAL500 Audio Features')
    parser.add_argument('--labels', default=True, help='Process CAL500 label processing')
