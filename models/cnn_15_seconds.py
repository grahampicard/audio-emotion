...
class CNN_simple_15s_32k(nn.Module):
    """ Basic model architecture taken from a github page """

    def __init__(self):
        super(CNN_simple_15s_32k, self).__init__()
...
class CNN_dev_15s_32k(nn.Module):
    """ Simplified model to enable more rapid development"""

    def __init__(self):
        super(CNN_dev_15s_32k, self).__init__()
