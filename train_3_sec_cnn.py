...
from models.cnn_3_seconds import CNN_dev_3s_32k
...
if __name__ == "__main__":
    ...
    # Load training data
    train_features, train_labels, valid_features, valid_labels, test_features, test_labels = load_section_level_stft()
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if (curr_valid_loss < min_valid_loss):
            ...
            if (args.save_model):
                ...
                torch.save(curr_model, f"./data/processed/cnn-{args.model}-3s_32k.pt")
